...
function PublicProfile() {
  ...
  const handleSubscribe = () => {
    ...
    setSubLoading(true);
    axios.post(`${API}/api/subscribe/${username}/`, {}, {
    ...
    <div className="profile-page">
      <div
        ...
        style={profile.cover_image ? {
          backgroundImage: `url(${getUrl(profile.cover_image)})`,
      ...
      <div className="profile-info-section">
        <div className="profile-avatar-row">
          <div
            ...
            style={profile.avatar_image ? {
              backgroundImage: `url(${getUrl(profile.avatar_image)})`,
              backgroundSize: 'cover',
              backgroundPosition: 'center'
            } : {}}
          >
          ...
          <div className="profile-actions">
            <button
              className={`btn-subscribe ${profile.is_subscribed ? 'subscribed' : ''}`}
        ...
        <div className="profile-stats-row">
          ...
          <div className="profile-stat">
            <div className="profile-stat-value">{profile.subscriber_count}</div>
        ...
        <div className="profile-posts-grid">
          {profile.posts.length === 0 ? (
            <p style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>No posts published yet.</p>
          ) : (
                ...
                <div className="post-card">
                  <div
                    ...
                    style={post.cover_image ? {
                      backgroundImage: `url(${getUrl(post.cover_image)})`,
                      backgroundSize: 'cover',
                      backgroundPosition: 'center'
                    } : {}}
                  >
